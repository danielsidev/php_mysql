...
$contato = $dao->read("agenda_contato", null, "where id=".$id)->fetch(PDO::FETCH_ASSOC);

$iduser = $contato["id"];
$contatos["nome"]=$contato["nome"];
$contatos["sobrenome"]=$contato["sobrenome"];
$contatos["genero"] = $contato["genero"];
$contatos["telefone"] = $contato["telefone"];
$contatos["celular"] = $contato["celular"];
